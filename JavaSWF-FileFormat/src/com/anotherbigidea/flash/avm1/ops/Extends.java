 ...
 * @author nickmain
 */
public class Extends extends AVM1OperationAggregation {

    public AVM1Operation superclass;
    public AVM1Operation subclass;
    
    /** @see com.anotherbigidea.flash.avm1.AVM1OperationAggregation#aggregate() */
    @Override
    public void aggregate() {
        if( superclass == null ) superclass = consumePrevious();
        if( subclass   == null ) subclass = consumePrevious();        
    }
